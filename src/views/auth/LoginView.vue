...
<template>
  ...
  >
    ...
    <!-- Main Content -->
    <div
      class="relative z-10 min-h-screen grid lg:grid-cols-2"
    >
      ...
      <div class="max-w-lg">
        <h1
          ...
          class="text-5xl leading-relaxed font-extrabold mb-2"
        >
          کشاورزی هوشمند،
          <br /> 
          تصمیم‌گیری دقیق‌تر
        ...
        <p
          ...
          "
        >
          اطلاعات مزرعه، وضعیت آب و هوا،
          رطوبت خاک و تحلیل داده‌ها را
          در یک داشبورد حرفه‌ای مشاهده کنید.
        </p>
      </div>
        <!-- Features -->
