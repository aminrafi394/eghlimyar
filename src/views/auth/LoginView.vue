...
const login = () => {
  ...
  if (!identifier.value || !password.value) {
    errorMessage.value = 'اطلاعات را کامل کنید'
  ...
  setTimeout(() => {
    const success = store.login(identifier.value, password.value)
      ...
      >
        ...
        >
          ...
          <div class="text-center">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-800">
              ورود به حساب کاربری
            </h2>

            <p class="mt-3 text-sm sm:text-base text-slate-500">خوش آمدید، برای ادامه وارد شوید</p>
          </div>
          ...
          <form class="mt-8" @submit.prevent="login">
            <!-- Identifier -->
            <div>
              <label for="identifier" class="block mb-2 text-sm font-semibold text-slate-700">
                نام کاربری
              </label>
            ...
            <div class="mt-5">
              ...
              <div class="relative">
                <input
                  ...
                  class="w-full border border-slate-300 rounded-2xl px-4 py-4 pl-12 outline-none transition focus:border-green-500 focus:ring-4 focus:ring-green-100"
                />
                ...
                <button
                  ...
                  class="absolute left-4 top-1/2 -translate-y-1/2 flex items-center justify-center text-slate-400 transition hover:text-green-600"
                >
            ...
            <div class="flex items-center justify-between gap-4 mt-6">
              ...
              <label class="flex items-center gap-2 cursor-pointer select-none">
                <input v-model="rememberMe" type="checkbox" class="w-4 h-4 accent-green-600" />
            ...
            >
              <span v-if="!isLoading"> ورود به سامانه </span>
          ...
          <!-- Footer -->
          <p class="text-center text-slate-400 text-sm mt-8 leading-6">
      ...
      >
        ...
        <div class="mb-10">
          <div class="flex items-center gap-5">
            ...
            <div>
              <h2 class="text-2xl xl:text-3xl font-bold">سامانه هوشمند کشاورزی</h2>

              <p class="text-white/80 mt-1 text-sm xl:text-base">
        ...
        <!-- Hero Title -->
        <div class="max-w-2xl">
          <h1 class="text-4xl xl:text-5xl 2xl:text-6xl leading-relaxed font-extrabold">
            کشاورزی هوشمند،
            <br />
            تصمیم‌گیری دقیق‌تر
          </h1>

          <p class="mt-8 text-lg xl:text-xl 2xl:text-2xl leading-10 text-white/90">
